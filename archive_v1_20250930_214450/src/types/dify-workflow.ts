...
export interface DifyVariableAggregatorEntry {
  variable: string
  value_selector: string[]
}

export interface DifyVariableAggregatorGroupEntry {
  variable: string
  selector: string[]
}

export interface DifyVariableAggregatorGroup {
  group_name: string
  variables: DifyVariableAggregatorGroupEntry[]
}

export interface DifyVariableAssignerAssignment {
  target_variable: string[]
  source_variable: string[]
  operation: 'overwrite' | 'append' | 'update'
}
...
export interface DifyIterationNode extends DifyNodeBase {
  type: typeof NODE_TYPES.ITERATION
  data: {
    title: string
...
export interface DifyVariableAssignerNode extends DifyNodeBase {
  type: typeof NODE_TYPES.VARIABLE_ASSIGNER
  data: {
    title: string
    assignments: DifyVariableAssignerAssignment[]
    advanced_settings?: {
...
export interface DifyVariableAggregatorNode extends DifyNodeBase {
  type: typeof NODE_TYPES.VARIABLE_AGGREGATOR
  data: {
    title: string
    variables: DifyVariableAggregatorEntry[]
    output_type?: 'string' | 'number' | 'object' | 'array'
    advanced_settings?: {
      group_enabled?: boolean
      groups?: DifyVariableAggregatorGroup[]
    }
  }
}
...
export interface DifyAnswerNode extends DifyNodeBase {
  type: typeof NODE_TYPES.ANSWER
  data: {
    title: string
    answer: string
    variable_selector?: string[]
...
export interface DifyParameterExtractorNode extends DifyNodeBase {
  type: typeof NODE_TYPES.PARAMETER_EXTRACTOR
  data: {
    title: string
    query: string
    model: DifyModelConfig
...
export interface DifyConversationVariablesNode extends DifyNodeBase {
  type: typeof NODE_TYPES.CONVERSATION_VARIABLES
  data: {
    title: string
...
export interface DifyListOperatorNode extends DifyNodeBase {
  type: typeof NODE_TYPES.LIST_OPERATOR
  data: {
    title: string
...
export interface DifyDocumentExtractorNode extends DifyNodeBase {
  type: typeof NODE_TYPES.DOCUMENT_EXTRACTOR
  data: {
    title: string
    variable_selector: string[]
...
export interface DifyQuestionClassifierNode extends DifyNodeBase {
  type: typeof NODE_TYPES.QUESTION_CLASSIFIER
  data: {
    title: string
    model: DifyModelConfig
    query_variable_selector: string[]
