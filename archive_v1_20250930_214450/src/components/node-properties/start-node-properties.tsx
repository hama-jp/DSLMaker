...
export function StartNodeProperties({ node, onUpdate }: StartNodePropertiesProps) {
  ...
  const handleVariableChange = useCallback((index: number, field: string, value: string | boolean) => {
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div className="space-y-1">
                        ...
                        <Select
                          ...
                          onValueChange={(value: string) => handleVariableChange(index, 'required', value === 'true')}
                        >
                          <SelectTrigger className="text-xs">
                            <SelectValue />
                          </SelectTrigger>
